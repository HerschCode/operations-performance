...
not a creation-time predictor — see [`docs/prediction-time-availability.md`](prediction-time-availability.md).
...
already recover 0.77–0.92; see [`docs/external-validation-bpi2012.md`](external-validation-bpi2012.md)
A prefix model built on this project's own BPI 2019 data gains only +0.03 to +0.13 ROC-AUC over
creation-time features (absolute 0.62–0.76), see [`docs/prefix-model-bpi2019.md`](prefix-model-bpi2019.md).
...
Pairs with [`operations-assistant`](https://operations-assistant.onrender.com), which lets a user *investigate*
...
> [`docs/less-degenerate-target.md`](less-degenerate-target.md).
...
training window only): [`docs/less-degenerate-target.md`](less-degenerate-target.md);
...
[`docs/statistical-significance.md`](statistical-significance.md).
...
Full breakdown in [`docs/data-contract.md`](data-contract.md).
...
[`docs/sql-window-functions.md`](sql-window-functions.md).
...
matters as much as the first: [`docs/api-latency.md`](api-latency.md).
